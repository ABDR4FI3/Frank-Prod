            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="index.php?option=com_galerie">Galeries</a></li>
                        <li class="breadcrumb-item active">Photos : <?php echo $galerie->getTitre() ?></li>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <ul class="sortable grid">
                                        ...
                                        ?>
                                            <li id="pic_<?php echo $photo->getId(); ?>">
                                                ...
                                                <a href="index.php?option=com_galerie&task=galeriephotos<?= "&id=" . $_GET['id'] . "&id_photo=" . $photo->getId(); ?>" class="btn btn-warning text-white btn-sm" style="position:absolute; top:-5px; right:27px;"><i class="fa fa-pencil-alt"></i></a>
                                                <input type="hidden" name="ordre[]" value="<?php echo $photo->getId(); ?>" />
                                                <img src="../images/galerie/<?php echo $photo->getPhoto(); ?>" width="" height="90" />
                                            </li>
                                        <?php
                                        }
                                        ?>
        ...
        $('form#sort').ajaxForm({
            ...
            success: function(theResponse) {
                ...
                if (parseInt(theResponse) === 1) {
                    ...
                    setTimeout(function() {
                        document.location = "index.php?option=com_galerie&task=galeriephotos&id=<?php echo $galerie->getId(); ?>";
                    }, 1500)
                } else {
