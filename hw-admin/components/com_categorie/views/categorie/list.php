	...
	<div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row align-items-center">
				...
				<div class="col-auto">
					<a href="index.php?option=com_categorie&task=add" class="btn btn-success mr-1" data-toggle="tooltip" data-placement="top" data-original-title="Ajouter catégorie">
								...
								<tbody>
									<?php foreach ($categories as $categorie) : ?>
										<tr>
											...
											<td><?php echo $categorie->getTitre(); ?></td>
											...
											<td class="text-right">
												...
												<a href="index.php?option=com_categorie&task=edit&id=<?= $categorie->getId(); ?>" class="btn btn-sm btn-white text-warning mr-2" data-toggle="tooltip" data-placement="top" data-original-title="Modifier"><i class="fa fa-pencil-alt"></i></a>
									...
									<tr class="sous" >
											<td><?php echo $categorie->getId(); ?></td>
											<td>___<?php echo $categorie->getTitre(); ?></td>
											<td><?php echo $categorie->getOrdre(); ?></td>
											<td class="text-right">
												<?php $state = $categorie->isActive() ? 'oui' : 'non'; ?>
												<?php $title = $categorie->isActive() ? 'Active' : 'Inactive'; ?>
...
<script type="text/javascript">
	$(function() {
		...
		var msgsucces = "Catégorie supprimée avec succès";

		$(document).on("click", ".delete", function() {
			var $btn = $(this);
			if (confirm("Attention ! les sous catégories seront supprimées également, êtes vous sûre")) {
